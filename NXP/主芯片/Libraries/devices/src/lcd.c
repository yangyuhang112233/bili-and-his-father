...
#define LCD_SCL   PEout(9)
#define LCD_SDA   PEout(10)
#define LCD_RST   PEout(7)
#define LCD_DC    PEout(11)
...
void LCD_Init(void)        
{
    ...
    GPIO_QuickInit(HW_GPIOE ,10,kGPIO_Mode_OPP);
...
//==============================================================
//函数名LCD_Dis_Num(unsigned char x,unsigned char y,unsigned int num,unsigned char N)
//功能描述:显示无符号整形变量
//参数：显示的位置（x,y），y为页范围0～7，要显示的变量，N为位数1~5
//返回：无
//==============================================================  
void LCD_Dis_Num(uint8_t x,uint8_t y,uint16_t num,uint8_t N)
{
	...
	LCD_P8x16Str(x,y,&n[5-N]);//从ASCII码中读取字节后显示
}
//==============================================================
//函数名LCD_Dis_Num(unsigned char x,unsigned char y,unsigned int num,unsigned char N)
//功能描述:显示双精度变量
